...
<div class="form-check form-check-inline">
  ...
  <label class="form-check-label" for="inlineCheckbox2">věkově neomezené</label>
            ...
            <center>
                <div class="row">
                    <div class="col-12">
                       <button type="button" class="btn btn-default disabled">Pro přidání pokusu se prosím přihlaste</button> 
                    </div>
                </div>
            </center>
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            ...
                            <button type="button" class="btn btn-default disabled">Pro přidání komentáře se prosím přihlaste</button>
                        </div>
                    </div>
                </div>
            </div>
